...
const quadrangle_climax_base = [
  { id: 'qcl_01', speaker: null, text: 'The quadrangle stretches endlessly. The protagonist stops, breathing heavily. Every muscle aches.', portrait: null, background: 'bg_quadrangle' },
  ...
  { id: 'qcl_03', speaker: 'Protagonist', text: 'Just... a little further...', portrait: 'portrait_protagonist', background: null },
  ...
  { id: 'qcl_05', speaker: 'Burnout', text: 'Why?', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_06', speaker: null, text: 'The protagonist turns. Burnout stands near the concrete benches. Slumped. Exhausted. Its glowing eyes dull.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_07', speaker: 'Burnout', text: 'Why take another step? Your legs are shaking. Your mind is blank.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_08', speaker: 'Protagonist', text: 'I have to finish... I have to get through this.', portrait: 'portrait_protagonist', background: null },
  { id: 'qcl_09', speaker: 'Burnout', text: 'To what end? There is always another assignment. Always another deadline.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_10', speaker: 'Burnout', text: 'You trade sleep for grades. You trade your health for a piece of paper. It never stops.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_11', speaker: null, text: 'A second voice cuts in. Sharp. Judging.', portrait: null, background: null },
  { id: 'qcl_12', speaker: 'Regret', text: 'And look where it got her.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_13', speaker: null, text: 'The shadows lengthen. REGRET steps out from the darkness. Much taller. Imposing.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_14', speaker: 'Regret', text: 'You worked yourself to the bone, and yet... you still failed.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_15', speaker: 'Protagonist', text: 'No... I tried my best.', portrait: 'portrait_protagonist', background: null },
  { id: 'qcl_16', speaker: 'Regret', text: 'Your best?', portrait: 'portrait_regret', background: null },
  { id: 'qcl_17', speaker: null, text: 'The courtyard distorts. A flash of memory.', portrait: null, background: null },
  { id: 'qcl_18', speaker: 'Regret', text: 'Do you remember the test? The one you studied three nights for? You still couldn\'t answer the final question.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_19', speaker: 'Regret', text: 'Do you remember the friends you pushed away because you were "too busy"? They stopped calling.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_20', speaker: 'Protagonist', text: 'Stop...', portrait: 'portrait_protagonist', background: null },
  { id: 'qcl_21', speaker: 'Burnout', text: 'She\'s too tired to argue.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_22', speaker: null, text: 'Burnout takes a slow, dragging step forward.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_23', speaker: 'Burnout', text: 'Just lay down. Close your eyes. It\'s so much easier to stop caring.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_24', speaker: 'Burnout', text: 'If you give up now, you won\'t have to feel this exhaustion anymore. The pressure will vanish.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_25', speaker: 'Regret', text: 'She can\'t give up. She\'s terrified of proving everyone right. Terrified that all those sacrifices meant nothing.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_26', speaker: 'Protagonist', text: 'I didn\'t sacrifice it for nothing! I\'m building a future!', portrait: 'portrait_protagonist', background: null },
  { id: 'qcl_27', speaker: 'Regret', text: 'A future built on broken pieces of yourself. Every choice you made left you emptier.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_28', speaker: 'Burnout', text: 'Look at you. There is barely anything left.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_29', speaker: null, text: 'The protagonist clutches her chest. Her heart is pounding. They are right. The fatigue. The guilt. It\'s suffocating.', portrait: 'portrait_protagonist', background: null },
  { id: 'qcl_30', speaker: 'Protagonist', text: '... Is this all there is? Just... being tired and hating myself for it?', portrait: 'portrait_protagonist', background: null },
  ...
  { id: 'qcl_32', speaker: 'Burnout', text: '... We are only the symptoms.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_33', speaker: 'Protagonist', text: 'What?', portrait: 'portrait_protagonist', background: null },
  { id: 'qcl_34', speaker: 'Regret', text: 'You think we are the enemy. You think fighting us will save you.', portrait: 'portrait_regret', background: null },
  { id: 'qcl_35', speaker: 'Regret', text: 'But we are only fragments of a larger crack.', portrait: 'portrait_regret', background: null },
  ...
  { id: 'qcl_37', speaker: 'Burnout', text: 'The exhaustion you feel... the guilt that haunts you...', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_38', speaker: 'Burnout', text: 'They were just preparing you for him.', portrait: 'portrait_burnout', background: null },
  ...
  { id: 'qcl_40', speaker: 'Regret', text: 'When every mistake is piled up... when the exhaustion breaks your will to live...', portrait: 'portrait_regret', background: null },
  { id: 'qcl_41', speaker: 'Regret', text: 'What is left?', portrait: 'portrait_regret', background: null },
  ...
  { id: 'qcl_43', speaker: 'Protagonist', text: 'No... no, what is that?!', portrait: 'portrait_protagonist', background: null },
  ...
  { id: 'qcl_45', speaker: 'Burnout', text: 'The end result.', portrait: 'portrait_burnout', background: null },
  { id: 'qcl_46', speaker: null, text: 'The towering figure fully manifests. It has no face, only a hollow void that pulls at the light. Whispers emanate from it—not just Burnout\'s tired voice, not just Regret\'s sharp tone, but hundreds of overlapping voices crying out in hopelessness.', portrait: 'portrait_despair', background: null },
  { id: 'qcl_47', speaker: 'Despair', text: '"Give up..."', portrait: 'portrait_despair', background: null },
  { id: 'qcl_48', speaker: 'Despair', text: '"It was all for nothing..."', portrait: 'portrait_despair', background: null },
  { id: 'qcl_49', speaker: 'Despair', text: '"There is no escape..."', portrait: 'portrait_despair', background: null },
  ...
  { id: 'qcl_52', speaker: 'Protagonist', text: 'I have to run.', portrait: 'portrait_protagonist', background: null },
  { id: 'qcl_53', speaker: null, text: 'The entity lets out a deafening, hollow scream. The ground violently shakes. The chase begins.', portrait: 'portrait_despair', background: null },
];
...
export const quadrangle_chase_resolution_good = [
  ...
  { id: 'qchr_g_02', speaker: 'Protagonist', text: "I'm so tired... but I can't stop here.", portrait: 'portrait_protagonist', background: null },
...
export const quadrangle_chase_resolution_bad = [
  ...
  { id: 'qchr_b_03', speaker: 'Protagonist', text: 'I can\'t... I have nothing left...', portrait: 'portrait_protagonist', background: null },
  ...
  { id: 'qchr_b_05', speaker: 'Despair', text: 'Then rest. Forever.', portrait: 'portrait_despair', background: null },
